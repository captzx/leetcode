...
SELECT Employee.Name AS Employee FROM Employee, (SELECT * FROM Employee WHERE Employee.ManagerId IS NULL) AS Employee2 WHERE Employee.ManagerId = Employee2.Id And Employee2.Salary < Employee.Salary
